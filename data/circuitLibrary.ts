...
const genLedOn = (): CircuitData => ({
    components: [
        ...
        { id: 'LED1', type: ComponentType.LED, x: 260, y: 280, rotation: 1, state: false, props: { name: 'LED1', diodeType: 'led', voltageDrop: 2.228, currentRating: 0.01, saturationCurrent: 9.32e-11, ledColor: '#ff4d4d' }, simData: { ...emptySim } }
    ],
    wires: [
