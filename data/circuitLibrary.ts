...
const genLedOn = (): CircuitData => ({
    components: [
        ...
        { id: 'LED1', type: ComponentType.LED, x: 260, y: 280, rotation: 1, state: false, props: { name: 'LED1', diodeType: 'led', voltageDrop: 2, currentRating: 0.02, ledColor: '#ff4d4d' }, simData: { ...emptySim } }
    ],
    wires: [
