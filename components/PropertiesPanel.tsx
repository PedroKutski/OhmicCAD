...
export const PropertiesPanel: React.FC<PropertiesPanelProps> = ({ target, onUpdateCompProps, onUpdateWireProps }) => {
  ...
  const renderLedProps = () => {
      ...
      return (
          <div className="space-y-4">
              <div>
                  <label className="text-[10px] text-zinc-500 uppercase font-bold block mb-1">Max LED Voltage (V)</label>
                  <input
                      type="number"
                      min={0.1}
                      step={0.1}
              ...
              <div>
                  ...
                  <input
                      ...
                      min={1e-18}
                      step={1e-12}
                      value={comp.props.saturationCurrent ?? 5e-12}
              ...
              <div>
                  ...
                  <input
                      ...
                      max={4}
                      step={0.1}
                      value={comp.props.idealityFactor ?? 1.9}
              ...
              <div>
                  ...
                  <input
                      ...
                      min={0}
                      step={0.1}
                      value={comp.props.internalSeriesResistance ?? 1.5}
